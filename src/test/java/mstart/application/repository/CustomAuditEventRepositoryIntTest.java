package mstart.application.repository;

import mstart.application.MStartApp;
import mstart.application.config.Constants;
import mstart.application.config.audit.AuditEventConverter;
import mstart.application.domain.PersistentAuditEvent;
...
import static mstart.application.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
